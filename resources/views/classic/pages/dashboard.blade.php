...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i>  Buy / Sell Instantly <h2 class="sr-only"> Buy / Sell Instantly </h2>
            </div>
               <div class="row">
              <div class="col-md-12">
                <div class="login-panel panel panel-default" style="margin:0">
                  <div class="panel-body form-section" style="margin-top: 10px;">
                    ...
                    <i class="exclamation triangle icon"></i>    Read the Disclaimer: All purchases and exchange transactions are handled by the data provider "Changelly". We cannot follow or see any of the transactions made here. For this reason, please do not send us an e-mail about your orders. Metaversetho only earns commission on your purchases.<h2 class="sr-only"> Buy / Sell Instantly </h2>
      </div>
    </div>
  </div>
</div>
